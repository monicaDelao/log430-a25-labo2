...
from queries.read_order import get_orders_from_mysql, get_orders_from_redis, get_highest_spending_users, get_most_sold_products
...
def get_report_highest_spending_users():
    """Get orders report: highest spending users from Redis"""
    try:
...
def get_report_most_sold_products():
    """Get orders report: most sold products from Redis"""
    try:
